...
> [!NOTE]
>  PUT - will Update all properties in a record. </br> PATCH - will update single property in a record </br> MERGE - will read the record automatically and then do PATCH
