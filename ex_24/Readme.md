...
*Difference between sap.m.table and sap.ui.table is sap.mp.table will display the table even if it has no data but ui.table will be displayed only it has data*
