...
2. *When we want to implement the curd CRUD operations on an entity set we also needs to write lots of code, this code will be written inside another class called Data provider class <b>(DPC)</b>. all the Implementation will be done inside this service*
